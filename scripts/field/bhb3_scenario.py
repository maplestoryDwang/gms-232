...
sm.invokeAtFixedRate(1000, BossConstants.LOTUS_ROBOT_ATOM_EXECUTION_DELAY, 0,
                     "createObstacleAtom", ObstacleAtomEnum.LotusRobotDebris, 4, BossConstants.LOTUS_ROBOT_ATOM_DAMAGE, BossConstants.LOTUS_OBSTACLE_ATOM_VELOCITY, BossConstants.LOTUS_ROBOT_ATOM_AMOUNT, BossConstants.LOTUS_ROBOT_ATOM_PROP)

sm.invokeAtFixedRate(2000, BossConstants.LOTUS_CRUSHER_ATOM_EXECUTION_DELAY, 0,
                     "createObstacleAtom", ObstacleAtomEnum.LotusCrusherDebris, 5, BossConstants.LOTUS_CRUSHER_ATOM_DAMAGE, BossConstants.LOTUS_OBSTACLE_ATOM_VELOCITY, BossConstants.LOTUS_CRUSHER_ATOM_AMOUNT, BossConstants.LOTUS_CRUSHER_ATOM_PROP)
