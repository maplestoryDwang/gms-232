...
#Simia faces, Face 0 = Smile
if sm.hasQuestCompleted(34208):
    sm.setMapTaggedObjectVisible("obj_01", True, 0, 0)
if sm.hasQuestCompleted(34210):
    sm.setMapTaggedObjectVisible("obj_02", True, 0, 0)
if sm.hasQuestCompleted(34212):
    sm.setMapTaggedObjectVisible("obj_03", True, 0, 0)
if sm.hasQuestCompleted(34214):
    sm.setMapTaggedObjectVisible("obj_04", True, 0, 0)
    sm.setMapTaggedObjectVisible("obj_05", True, 0, 0)

if sm.hasQuest(34215) and not sm.hasQuestCompleted(34215):
    sm.lockInGameUI(True, False)
    sm.removeAdditionalEffect()
    sm.spawnNpc(3003160, 600, -119)
    ...
    sm.sendNext("#face0#Oh, #h #! You're okay, and you brought us a #bSlurpy Fruit#k!")
    sm.sendNext("Okay, lemme just grind up some Slurpy Fruit, smear it around the top, and... It's done! Who's ready to try the #bDelicious Beefy Tastesplosion Sandwich#k?")
    sm.setInnerOverrideSpeakerTemplateID(3003155) # Pidol
    sm.sendSay("I... I want to... eat... first. Heheheh.")
    sm.sendSay("Om... nom... Gulp..")
    sm.sendSay("BEEELCH! Ohh... Oooohhhh!")
    sm.setInnerOverrideSpeakerTemplateID(3003151) # Simia
    sm.sendNext("Pidol!")
    sm.sendNext("Pidol!? What's wrong?")
    sm.setInnerOverrideSpeakerTemplateID(3003155) # Pidol
    sm.sendSay("This taste... It's simply divine... That heavenly harmony of flavors... That crisp, yet chewy texture... It's as though the five tastes were having a party, and there comes a knock at the door... And in walks a sixth, as-yet undiscovered flavor...! My taste buds are overwhelmed!")
    sm.setInnerOverrideSpeakerTemplateID(3003154) # Pimi
    sm.sendNext("Pidol! You're back to normal!")
    sm.setInnerOverrideSpeakerTemplateID(3003155) # Pidol
    sm.sendSay("Huh? What you mean? I always normal... Heheheheh.")
    sm.setInnerOverrideSpeakerTemplateID(3003151) # Simia
    sm.sendNext("#face0#I guess the intense flavor must have momentarily #bshocked Pidol back to his senses#k. I think it's safe to say that our sandwich is a success!")
    sm.sendNext("I hope that Muto likes our #bDelicious Beefy Tastesplosion Sandwich#k...")
    sm.setInnerOverrideSpeakerTemplateID(3003155) # Pidol
    sm.sendSay("Why shake?!")
    sm.setInnerOverrideSpeakerTemplateID(3003154) # Pimi
