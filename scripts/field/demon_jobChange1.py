FERDI = 2159311
SKILLS = [30010166, 30011167, 30011168, 30011169, 30011170] # Tutorial skills
...
item = chr.getEquippedInventory().getItemBySlot(11) # Weapon slot
if item is not None:
    chr.consumeItem(item)

sm.setSpeakerID(FERDI)
for skill in SKILLS:
    sm.removeSkill(skill)
