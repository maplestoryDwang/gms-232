...
if not "helper=clear" in sm.getQRValue(21019):
    ...
    sm.hireTutor(True)
    sm.startQuest(21010)
    chr.removeSkillAndSendPacket(20000014)
    chr.removeSkillAndSendPacket(20000015)
    chr.removeSkillAndSendPacket(20000016)
    chr.removeSkillAndSendPacket(20000017)
    chr.removeSkillAndSendPacket(20000018)
    sm.warp(140090100, 1)
