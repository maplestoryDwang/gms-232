#  Scarecrow Summoning Sack (2434328)
#  100% Straw - High Def
...
def spawnMob(hp, level, pdr):
    mob = MobData.getMobDeepCopyById(HIGH_DEF_STRAW_DUMMY)
...
if not field.getInfo().isTown():
    ...
    if not Util.isLong(hpStr):
        ...
        sm.invokeAfterDelay(DURATION, "removeMobByTemplateId", HIGH_DEF_STRAW_DUMMY)
