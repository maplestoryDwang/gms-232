#  Scarecrow Summoning Sack (2434329)
#  75% Straw - Med Def
...
def spawnMob(hp, level, pdr):
    mob = MobData.getMobDeepCopyById(MED_DEF_STRAW_DUMMY)
...
if not field.getInfo().isTown():
    ...
    if not Util.isLong(hpStr):
        ...
        sm.invokeAfterDelay(DURATION, "removeMobByTemplateId", MED_DEF_STRAW_DUMMY)
