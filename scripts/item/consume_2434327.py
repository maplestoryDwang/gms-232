#  Scarecrow Summoning Sack (2434327)
#  25% Oak - Low Def
...
def spawnMob(hp, level, pdr):
    mob = MobData.getMobDeepCopyById(LOW_DEF_OAK_DUMMY)
...
if not field.getInfo().isTown():
    ...
    if not Util.isLong(hpStr):
        ...
        sm.invokeAfterDelay(DURATION, "removeMobByTemplateId", LOW_DEF_OAK_DUMMY)
