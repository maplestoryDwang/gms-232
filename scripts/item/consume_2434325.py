#  Scarecrow Summoning Sack (2434325)
#  100% Oak - High Def
...
def spawnMob(hp, level, pdr):
    mob = MobData.getMobDeepCopyById(HIGH_DEF_OAK_DUMMY)
...
if not field.getInfo().isTown():
    ...
    if not Util.isLong(hpStr):
        ...
        sm.invokeAfterDelay(DURATION, "removeMobByTemplateId", HIGH_DEF_OAK_DUMMY)
