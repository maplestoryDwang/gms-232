#  Scarecrow Summoning Sack (2434326)
#  75% Oak - Med Def
...
def spawnMob(hp, level, pdr):
    mob = MobData.getMobDeepCopyById(MID_DEF_OAK_DUMMY)
...
if not field.getInfo().isTown():
    ...
    if not Util.isLong(hpStr):
        ...
        sm.invokeAfterDelay(DURATION, "removeMobByTemplateId", MID_DEF_OAK_DUMMY)
