# id 39927 ([Daily Quest] Defeat 700 Ebonstar Bombardiers)
...
sm.setParam(2)
sm.sendNext("#b(You gave the Dawn Priest the information you obtained from observing the monsters up close.)#k")
sm.setParam(0)
