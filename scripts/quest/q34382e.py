# id 34382 ([Daily Quest] Defeat 200 Wood Board Alley Citizens)
...
sm.setParam(2)
sm.sendNext("#b(You gave Gray Mask the information you obtained from observing the Wood Board Alley Citizens up close.)#k")
sm.setParam(0)
