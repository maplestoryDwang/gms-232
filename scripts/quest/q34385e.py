# id 34385 ([Daily Quest] Defeat 200 Angry Victory Plates)
...
sm.setParam(2)
sm.sendNext("#b(You gave Gray Mask the information you obtained from observing the Angry Victory Plates up close.)#k")
sm.setParam(0)
