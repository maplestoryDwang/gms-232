# id 38152 ([Daily Quest] Defeat 1000 Sandblade Marauders)
...
sm.setParam(2)
sm.sendNext("#b(You gave Archelon the information you obtained from observing the monsters up close.)#k")
sm.setParam(0)
sm.sendSay("You have " + str(QuestConstants.HOTEL_ARCUS_WEEKLY_AMOUNT - (remainingTasks - 1)) + " tasks completed this week. Thanks to you, we're one step closer to understanding this place.")
if remainingTasks == 1:
