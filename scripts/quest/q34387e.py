# id 34387 ([Daily Quest] Defeat 200 Angry Masquerade Citizens)
...
sm.setParam(2)
sm.sendNext("#b(You gave Gray Mask the information you obtained from observing the Angry Masquerade Citizens up close.)#k")
sm.setParam(0)
