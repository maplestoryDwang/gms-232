# id 34146 ([Daily Quest] Collect 50 Tranquil Erdas Samples), field 450001000
...
sm.setParam(2)
sm.sendNext("你搜集到了50个#t4034929:#。来，我把1个#i1712001:# #t1712001:#和1个#i2614029:# #t2614029:#送给你。搜集到的样本一定会对研究起到很大的帮助。")
sm.setParam(0)
