# id 34389 ([Daily Quest] Defeat 200 Red Dancing Shoes)
...
sm.setParam(2)
sm.sendNext("#b(You gave Gray Mask the information you obtained from observing the Red Dancing Shoes up close.)#k")
sm.setParam(0)
