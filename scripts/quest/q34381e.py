# id 34381 ([Daily Quest] Defeat 200 Paper Bag Alley Citizens)
...
sm.setParam(2)
sm.sendNext("#b(You gave Gray Mask the information you obtained from observing the Paper Bag Alley Citizens up close.)#k")
sm.setParam(0)
