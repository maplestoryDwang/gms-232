# id 34393 ([Daily Quest] Defeat 200 Red-eyed Gargoyles)
...
sm.setParam(2)
sm.sendNext("#b(You gave Gray Mask the information you obtained from observing the Red-eyed Gargoyles up close.)#k")
sm.setParam(0)
