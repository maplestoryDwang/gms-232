# id 34460 ([Arcana] Blooms Under the Moon), field 450005100
sm.setSpeakerID(3003303) # Small Spirit
...
res = sm.sendAskAccept("But we can cut a trimming from the withered Floral Flute and plant it in the place with the most moonlight!")
