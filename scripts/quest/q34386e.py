# id 34386 ([Daily Quest] Defeat 200 Crooked Victory Plates)
...
sm.setParam(2)
sm.sendNext("#b(You gave Gray Mask the information you obtained from observing the Crooked Victory Plates up close.)#k")
sm.setParam(0)
