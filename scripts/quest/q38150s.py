...
import random
# id 38150 ([Daily Quest] Clean Up Around Hotel Arcus), field 410003000

quests =[38151, 38152, 38153, 38154, 38155, 38156]
selectedQuests = [0, 0, 0, 0, 0, 0]
...
for i in range(QuestConstants.HOTEL_ARCUS_WEEKLY_AMOUNT):
    selectedQuests[i] = 1
...
def replaceMissions():
    ...
    text = "All right. To replace the missions you don't want, I've found new missions. Here are your " + str(QuestConstants.HOTEL_ARCUS_WEEKLY_AMOUNT) + "for the week.\r\n\r\n"
...
sm.setParam(256)
sm.sendNext("I'm Captain Achelon of Hotel Arcs. \r\nLately, more Seekers than usual have been visiting my hotel.")
sm.sendNext("Lots of overdue room charges. \r\n#h #, Achelon needs your help.")
#Do this to initialize the daily Entry for cernium
remainingTasks = sm.getRemainingDailyEntries(DailyEntry.HotelArcus)
if sm.sendAskYesNo("#b#h ##k, Captain Achelon will give you a thank you gift if you help out.?"):
    sm.sendNext("#h #, hunt any monsters around here. \r\n#bSelect one of the monster hunting missions in the Cernium region#k and return once you've completed them.")
