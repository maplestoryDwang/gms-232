...
if parentID == 15:
    if stage3OrderArray[0] == 3:
        sm.invokeForParty("showObjectFieldEffect","an00")
    ...
    if stage3OrderArray[0] == 2:
        sm.invokeForParty("showObjectFieldEffect","an01")
        sm.teleportToPortal(18)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[0] == 1:
        sm.invokeForParty("showObjectFieldEffect","an02")
        sm.teleportToPortal(18)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[1] == 1:
        sm.invokeForParty("showObjectFieldEffect","an10")
    ...
    if stage3OrderArray[1] == 2:
        sm.invokeForParty("showObjectFieldEffect","an11")
        sm.teleportToPortal(21)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[1] == 3:
        sm.invokeForParty("showObjectFieldEffect","an12")
        sm.teleportToPortal(21)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[2] == 3:
        sm.invokeForParty("showObjectFieldEffect","an20")
    ...
    if stage3OrderArray[2] == 2:
        sm.invokeForParty("showObjectFieldEffect","an21")
        sm.teleportToPortal(24)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[2] == 1:
        sm.invokeForParty("showObjectFieldEffect","an22")
        sm.teleportToPortal(24)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[3] == 3:
        sm.invokeForParty("showObjectFieldEffect","an30")
    ...
    if stage3OrderArray[3] == 2:
        sm.invokeForParty("showObjectFieldEffect","an31")
        sm.teleportToPortal(27)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[3] == 1:
        sm.invokeForParty("showObjectFieldEffect","an32")
        sm.teleportToPortal(27)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[4] == 1:
        sm.invokeForParty("showObjectFieldEffect","an40")
    ...
    if stage3OrderArray[4] == 2:
        sm.invokeForParty("showObjectFieldEffect","an41")
        sm.teleportToPortal(30)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[4] == 3:
        sm.invokeForParty("showObjectFieldEffect","an42")
        sm.teleportToPortal(30)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[5] == 1:
        sm.invokeForParty("showObjectFieldEffect","an50")
    ...
    if stage3OrderArray[5] == 2:
        sm.invokeForParty("showObjectFieldEffect","an51")
        sm.teleportToPortal(33)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[5] == 3:
        sm.invokeForParty("showObjectFieldEffect","an52")
        sm.teleportToPortal(33)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[6] == 3:
        sm.invokeForParty("showObjectFieldEffect","an60")
    ...
    if stage3OrderArray[6] == 1:
        sm.invokeForParty("showObjectFieldEffect","an61")
        sm.teleportToPortal(36)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[6] == 2:
        sm.invokeForParty("showObjectFieldEffect","an62")
        sm.teleportToPortal(36)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[7] == 3:
        sm.invokeForParty("showObjectFieldEffect","an70")
    ...
    if stage3OrderArray[7] == 2:
        sm.invokeForParty("showObjectFieldEffect","an71")
        sm.teleportToPortal(39)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[7] == 1:
        sm.invokeForParty("showObjectFieldEffect","an72")
        sm.teleportToPortal(39)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[8] == 1:
        sm.invokeForParty("showObjectFieldEffect","an80")
    ...
    if stage3OrderArray[8] == 3:
        sm.invokeForParty("showObjectFieldEffect","an81")
        sm.teleportToPortal(42)
    else:
        sm.teleportToPortal(0)
    ...
    if stage3OrderArray[8] == 2:
        sm.invokeForParty("showObjectFieldEffect","an82")
        sm.teleportToPortal(42)
    else:
        sm.teleportToPortal(0)
