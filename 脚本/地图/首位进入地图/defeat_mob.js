        ...
        if (status === a++) {
            switch (cm.getMapId()) {
                ...
                case 931050428:
                    ...
                    break;
                case 931050429:
                    cm.spawnMobLimit(9300515, 1, 631, 138, 100);
                    break;
                case 931050430:
                    cm.spawnMobLimit(9300516, 1, -107, 2485, 100);
                    break;
                case 931050431:
                    cm.spawnMobLimit(9300517, 1, 298, -570, 100);
                    break;
                case 931050432:
                    cm.spawnMobLimit(9300518, 1, 448, 181, 100);
                    break;
                case 931050433:
                    cm.spawnMobLimit(9300519, 1, 34, 181, 100);
                    break;
                case 931050434:
