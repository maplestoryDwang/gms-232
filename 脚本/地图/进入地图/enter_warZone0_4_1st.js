...
function action(f, E, e) {
  ...
  if (status <= V++) {
    ...
    cm.spawnMobLimit(2400017, 1, 300, 29, 100);
    cm.spawnMobLimit(2400017, 1, 300, 29, 100);
    cm.spawnMobLimit(2400017, 1, 400, 29, 100);
    cm.spawnMobLimit(2400017, 1, 400, 29, 100);
    cm.spawnMobLimit(2400017, 1, 500, 29, 100);
    cm.spawnMobLimit(2400017, 1, 500, 29, 100);
    cm.spawnMobLimit(2400017, 1, 600, 29, 100);
    cm.spawnMobLimit(2400017, 1, 600, 29, 100);
    cm.spawnMobLimit(2400017, 1, 700, 29, 100);
    cm.spawnMobLimit(2400017, 1, 700, 29, 100);
    cm.spawnMobLimit(2400017, 1, 800, 29, 100);
    cm.spawnMobLimit(2400017, 1, 800, 29, 100);
    cm.spawnMobLimit(2400017, 1, 900, 29, 100);
    cm.spawnMobLimit(2400017, 1, 900, 29, 100);
    cm.spawnMobLimit(2400017, 1, 1000, 29, 100);
    cm.spawnMobLimit(2400017, 1, 1000, 29, 100);
