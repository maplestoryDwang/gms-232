...
function action(f, E, e) {
  ...
  if (status <= V++) {
    ...
    cm.spawnMobLimit(2400120, 1, -300, 182, 100);
    cm.spawnMobLimit(2400120, 1, -200, 182, 100);
    cm.spawnMobLimit(2400120, 1, -100, 182, 100);
    ...
    cm.spawnMobLimit(2400120, 1, 400, 182, 100);
    cm.spawnMobLimit(2400120, 1, 500, 182, 100);
    cm.spawnMobLimit(2400120, 1, 600, 182, 100);
    cm.spawnMobLimit(2400120, 1, 700, 182, 100);
    cm.spawnMobLimit(2400120, 1, 800, 182, 100);
    cm.spawnMobLimit(2400120, 1, 900, 182, 100);
