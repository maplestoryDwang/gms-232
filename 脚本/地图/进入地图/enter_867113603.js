...
function action(f, E, e) {
  ...
  if (status <= V++) {
    ...
    if (status === V++) {
      ...
      cm.npc_ChangeController(9400202, "oid=23154053", 70, 240, 19, 20, 120, 1, false, 0, false);
      cm.npc_SetSpecialAction("oid=23154053", 'summon', 0, 0);
      cm.inGameDirectionEvent_ForcedFlip(1);
      cm.inGameDirectionEvent_MoveAction(4);
      cm.emotion(18, 15000);
      cm.inGameDirectionEvent_PushScaleInfo(0, 2000, 0, 100, 220);
      cm.curNodeEventEnd(true);
    } else {
      if (status === V++) {
          ...
          if (status === V++) {
            ...
            if (status === V++) {
              ...
              if (status === V++) {
                ...
                if (status === V++) {
                  cm.sendNormalTalk_Bottom("哎呦喂，我还担心你要是真死了，我该怎么给你写墓碑……“这里沉睡着被漂漂猪顶死的勇士#h0#”这么写不是太凄惨了吗？", 37, 9400202, true, true);
                } else {
                  if (status === V++) {
                    cm.inGameDirectionEvent_ForcedFlip(1);
                    cm.inGameDirectionEvent_AskAnswerTime(500);
                        ...
                        if (status === V++) {
                          ...
                          if (status === V++) {
                            ...
                            if (status === V++) {
                              ...
                              cm.npc_LeaveField("oid=23154053");
                              cm.npc_LeaveField("oid=23154053");
                            }
                          }
                        }
