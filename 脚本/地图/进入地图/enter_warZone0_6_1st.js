...
function action(f, E, e) {
  ...
  if (status <= V++) {
    ...
    cm.spawnMobLimit(2400018, 1, 2000, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2100, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2100, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2200, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2200, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2300, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2300, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2400, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2500, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2156, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2670, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2377, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2461, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2400, 29, 100);
    cm.spawnMobLimit(2400018, 1, 2169, 29, 100);
