...
function action(f, E, e) {
  ...
  if (status <= V++) {
    ...
    cm.spawnMobLimit(2400126, 1, -200, 182, 100);
    cm.spawnMobLimit(2400124, 1, -100, 182, 100);
    cm.spawnMobLimit(2400125, 1, 0, 182, 100);
    cm.spawnMobLimit(2400126, 1, 100, 182, 100);
    cm.spawnMobLimit(2400124, 1, 200, 182, 100);
    cm.spawnMobLimit(2400125, 1, 300, 182, 100);
    cm.spawnMobLimit(2400126, 1, 400, -28, 100);
