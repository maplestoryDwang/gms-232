...
function action(f, E, e) {
  if (cm.isQuestFinished(39917) && cm.getNumberFromQuestInfo(39917, 'dir') == 0) {
    action2(f, E, e);
  } else {
    action1(f, E, e);
  }
...
function action2(f, E, e) {
  ...
  if (status <= V++) {
    ...
    if (status === V++) {
      ...
      cm.npc_SetSpecialAction("oid=63582920", "special", -1, 1);
      cm.npc_SetSpecialAction("oid=63582921", "special", -1, 1);
      cm.setStringForQuestInfo(39900, '14', 'h0');
      cm.setStringForQuestInfo(39900, '15', 'h0');
      cm.setStringForQuestInfo(39900, '24', 'h0');
