                ...
                if (940303500 == cm.getMapId()) {
                  ...
                  if (cm.getNumberFromQuestInfo(35706, "guide") == 1 && cm.getMazeDestination() != cm.getMapId()) {
                    ...
                    if (validMobs() == 0) {
                      ...
                      var O = ["up00", "down00", "left00", "right00", "exit00"];
                      O.forEach(function (b) {
                        if (cm.getMap().getReactorByName(b).getState() == 1) {
                          cm.getMap().getReactorByName(b).forceHitReactor(cm.getPlayer(), 2);
                        }
                      });
                    } else {
