...
function action(f, E, e) {
  ...
  if (status <= V++) {
    ...
    cm.spawnMobLimit(2400020, 1, 400, 29, 100);
    cm.spawnMobLimit(2400020, 1, 500, 29, 100);
    cm.spawnMobLimit(2400020, 1, 500, 29, 100);
    cm.spawnMobLimit(2400020, 1, 600, 29, 100);
    cm.spawnMobLimit(2400020, 1, 600, 29, 100);
    cm.spawnMobLimit(2400020, 1, 700, 29, 100);
    cm.spawnMobLimit(2400020, 1, 700, 29, 100);
    cm.spawnMobLimit(2400020, 1, 800, 29, 100);
    cm.spawnMobLimit(2400020, 1, 800, 29, 100);
    cm.spawnMobLimit(2400020, 1, 900, 29, 100);
    cm.spawnMobLimit(2400020, 1, 900, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1000, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1000, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1100, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1100, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1200, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1200, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1300, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1300, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1400, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1400, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1500, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1500, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1600, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1600, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1700, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1700, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1800, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1800, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1900, 29, 100);
    cm.spawnMobLimit(2400020, 1, 1900, 29, 100);
