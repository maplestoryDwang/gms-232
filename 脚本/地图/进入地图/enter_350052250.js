...
function action(f, E, e) {
  ...
  if (status <= V++) {
    ...
    cm.npc_ChangeController(1540718, "oid=37530", 1005, -113, 14, 956, 1055, 1, false, 0, false);
    cm.updateInfoQuest(33213, "area=D1_Z33;x=2;y=3");
    cm.updateInfoQuest(33214, "ul=983000");
    cm.openUI(254);
