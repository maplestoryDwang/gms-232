...
function action(f, E, e) {
  ...
  if (status <= V++) {
    ...
    cm.addPopupSay(1531003, 2000, "#face2#超能力者,  小心技能封印！！", '', 0);
    ...
    cm.spawnMobLimit(2700315, 1, 700, 155, 100);
    cm.spawnMobLimit(2700316, 1, 800, 154, 100);
    cm.spawnMobLimit(2700316, 1, 800, 154, 100);
    cm.spawnMobLimit(2700316, 1, 900, 149, 100);
    cm.spawnMobLimit(2700316, 1, 900, 149, 100);
    cm.spawnMobLimit(2700316, 1, 1000, 151, 100);
    cm.spawnMobLimit(2700316, 1, 1000, 151, 100);
    cm.spawnMobLimit(2700316, 1, 1100, 150, 100);
    cm.spawnMobLimit(2700316, 1, 1100, 150, 100);
    cm.spawnMobLimit(2700316, 1, 1200, 147, 100);
    cm.spawnMobLimit(2700316, 1, 1200, 147, 100);
    cm.spawnMobLimit(2700316, 1, 1300, 155, 100);
    cm.spawnMobLimit(2700316, 1, 1300, 155, 100);
    cm.spawnMobLimit(2700316, 1, 1400, 157, 100);
