...
function action(f, E, e) {
  ...
  if (status <= V++) {
    ...
    if (status === V++) {
      ...
      cm.npc_ChangeController(3004447, "oid=1138949", 594, 14, -1, 544, 644, 0, true, 0, false);
      cm.npc_SetSpecialAction("oid=1138949", "summon", 0, 0);
      cm.npc_ChangeController(3004456, "oid=1138952", 759, -29, -1, 709, 809, 1, true, 0, false);
      cm.npc_SetSpecialAction("oid=1138952", 'summon', 0, 0);
      cm.npc_ChangeController(3004454, "oid=1138954", 525, 14, -1, 475, 575, 0, false, 0, false);
