...
function action(f, E, e) {
  ...
  if (status <= V++) {
    ...
    if (status === V++) {
      ...
      if (status === V++) {
        cm.fieldEffect_复合图片动画(["Effect/Direction20.img/bossWill/intro_spine/skeleton", '2', '', "intro"], [0, 0, 1, 0, 0, 0, 0, 1]);
        cm.fieldEffect_PlayFieldSound("Sound/SoundEff.img/esfera/boss/intro2", 200);
