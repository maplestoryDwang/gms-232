...
function action(f, E, e) {
  ...
  if (status <= V++) {
    ...
    if (status === V++) {
      ...
      cm.updateInfoQuest(64001, "dir1=1;man=110;stage=4;enemy=513;seq=0;mine=0;Fidx=0;companion=146;dir0=0");
      cm.curNodeEventEnd(true);
      cm.setInGameDirectionMode(true, false, true);
      cm.inGameDirectionEvent_SetAdditionalEffectVisibleForInGameDirection();
      cm.fieldEffect_InsertCanvas(1, 255, 0, 0, 0, 0, 0);
      cm.npc_ChangeController(9400672, "oid=7550511", -600, 145, 14, -650, -550, 0, true, false);
      cm.npc_SetSpecialAction("oid=7550511", "summon", 0, 0);
        ...
        if (status === V++) {
          ...
          if (status === V++) {
            ...
            if (status === V++) {
              ...
              if (status === V++) {
                cm.npc_SetSpecialAction("oid=7550511", "die1", 1, 0);
                cm.fieldEffect_PlayFieldSound("PL_3min/CubeBreak", 100);
                cm.inGameDirectionEvent_AskAnswerTime(1000);
              } else {
                if (status === V++) {
                  cm.npc_LeaveField("oid=7550511");
                  cm.npc_LeaveField("oid=7550511");
                    ...
                    if (status === V++) {
                      ...
                      if (status === V++) {
                        ...
                        if (status === V++) {
                          ...
                          cm.updateInfoQuest(64001, "dir1=1;man=42;stage=4;enemy=513;seq=0;mine=0;Fidx=0;companion=146;dir0=0");
                          ...
                          if (status === V++) {
                            ...
                            cm.sendNormalTalk_Bottom("#face1#壁垒已经被攻破了！！！\r\n……没办法了，所有人进入城堡！快！", 37, 9400581, true, true);
                          } else if (status === V++) {
                            cm.updateInfoQuest(64002, "man=42;stage=5;enemy=3;man0=0;man1=0;companion=9");
                            cm.dispose();
                            cm.warp(867233600, 0);
                          }
                        }
