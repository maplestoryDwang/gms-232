            ...
            if (status === a++) {
                ...
                if (status === a++) {
                    ...
                    if (status === a++) {
                        ...
                        if (status === a++) {
                            cm.askYesNo("没错，达到#b日冕3级#k的福利就是1个#r#e#i2534000:# #t2534000##k#n！\r\n不说废话了，你现在就要领取吗？", 4, 9400965)
                        } else {
                            if (status === a++) {
                                cm.setNumberForQuestInfo(500831, "burn", 1);
                                cm.sendNormalTalk("好的好的！好好使用吧！但是#b日冕庆典的特殊福利#k可不止这些哦！", 4, 9400965, false, true);
                                cm.gainItem(2534000, 1)
                            } else {
                                if (status === a++) {
                                    cm.sendNormalTalk("当然，如果你想要获得#b更强的活动效果#k和#b更珍贵的特别福利#k，就必须提高#b日冕等级#k。\r\n原来如此……如果你#b累积获得1200分#k就能达到下个日冕等级了！", 4, 9400965, true, true)
                                } else {
                                    if (status === a++) {
