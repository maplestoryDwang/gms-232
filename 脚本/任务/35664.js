...
function start(mode, type, selection) {
	...
	if (status <= i++) {
		...
		cm.askYesNo("请前去攻破黑魔法师的残像，找到1个#i4036464# #b#z4036464#，#k然后攻破军团长#r高级路西德#k的残像，可以吗？", 4, 9063152);
	} else if (status == i++) {
		cm.forceStartQuest();
		var jobId = cm.getJob();
		cm.sendOk("你应该已经知道了，黑暗痕迹只有在特殊条件下才能被刻印上去。请在满足以下条件的同时击败#r高级路西德。#k\r\n\r\n" +
			"#e#r<任务完成条件>#k#n\r\n" +
			" #b- 独自攻破\r\n" +
			" - 只能使用50个挑战者特殊药水攻破\r\n" +
			" - 2人组队时最终伤害降低50%，哪怕只有一人失败，所有队员同时失败，当留有死亡计数的队员死亡时，路西德的血量不到1，无法减少#k\r\n\r\n" +
