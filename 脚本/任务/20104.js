...
function end(c, b, a) {
    ...
    if (status == 0) {
        cm.askYesNo("Have you made your decision? The decision will be final, so think carefully before deciding what to do. Are you sure you want to become a Night Walker?")
    } else {
        if (status == 1) {
