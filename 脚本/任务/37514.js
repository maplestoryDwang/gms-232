                                                        ...
                                                        if (status === a++) {
                                                            ...
                                                            if (status === a++) {
                                                                ...
                                                                if (status === a++) {
                                                                    ...
                                                                    if (status === a++) {
                                                                        cm.forceStartQuest(37514, "");
                                                                        cm.updateInfoQuest(37500, "00=h0;10=h0;11=h0;04=h0;05=h0;23=h0;06=h0;25=h0;07=h0;55=h0");
                                                                        cm.dispose()
                                                                    }
                                                                }
                                                            }
            ...
            if (status === a++) {
                ...
                if (status === a++) {
                    ...
                    if (status === a++) {
                        ...
                        if (status === a++) {
                            cm.OnStartNavigation(993150000, 1, "3004520", 37514);
                            cm.updateInfoQuest(37514, "NpcSpeech=30045191");
                            cm.dispose()
                        }
                    }
                }
            ...
            if (status === a++) {
                ...
                if (status === a++) {
                    ...
                    if (status === a++) {
                        ...
                        if (status === a++) {
                            cm.OnStartNavigation(993150000, 1, "3004521", 37514);
                            cm.updateInfoQuest(37514, "NpcSpeech=30045191/30045202");
                            cm.dispose()
                        }
                    }
                }
                    ...
                    if (status === a++) {
                        ...
                        if (status === a++) {
                            ...
                            if (status === a++) {
                                ...
                                if (status === a++) {
                                    cm.OnStartNavigation(993150000, 1, "3004512", 37514);
                                    cm.updateInfoQuest(37514, "NpcSpeech=30045191/30045202/30045213");
                                    cm.dispose()
                                }
                            }
                        }
            ...
            if (status === a++) {
                ...
                if (status === a++) {
                    ...
                    if (status === a++) {
                        ...
                        cm.updateInfoQuest(37500, "00=h0;10=h0;11=h0;04=h0;05=h0;23=h0;06=h0;25=h0;07=h0;55=h1");
                        cm.eventSKill(0);
                        cm.setInGameDirectionMode(true, false, true);
                        cm.inGameDirectionEvent_SetAdditionalEffectVisibleForInGameDirection2();
                        cm.fieldEffect_InsertCanvas(1, 255, 0, 0, 0, 0, 0);
                        cm.setStandAloneMode(true);
                        cm.onTeleport(0, 3, cm.getPlayer().getId(), -520, -12);
                        cm.npc_ChangeController(3004455, "oid=63519072", -423, 14, 18, -473, -373, 1, false, 1000, false);
                        cm.npc_SetSpecialAction("oid=63519072", "summon", 0, 0);
                        cm.inGameDirectionEvent_PushScaleInfo(0, 0, 1500, 0, -423, -10)
                    } else {
                        if (status === a++) {
