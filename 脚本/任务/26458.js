            ...
            if (a == 0) {
                ...
                if (a == 1) {
                    ...
                    if (a == 2) {
                        ...
                        if (a == 3) {
                            cm.sendOk("Enjoy amazing Everybody In Event benefits！I hope you have a great time!");
                            cm.dispose()
                        }
                    }
                }
