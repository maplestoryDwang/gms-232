...
function start(mode, type, selection) {
	...
	if (status <= i++) {
		...
		cm.askYesNo("请前去攻破黑魔法师的残像，找到1个#i4036460# #b#z4036460#，#k并且击败军团长#r高级麦格纳斯#k的残像，可以吗？", 4, 9063152);
	} else if (status == i++) {
		cm.forceStartQuest();
		var jobId = cm.getJob();
		if (jobId == '10112') {
			cm.sendOk("你应该已经知道了，黑暗痕迹只有在特殊条件下才能被刻印上去。请在满足以下条件的同时击败#r高级麦格纳斯。#k\r\n\r\n" +
				"#e#r<任务完成条件>#k#n\r\n" +
				" #b- 独自攻破\r\n" +
				" - 只装备封印的创世武器和辅助武器\r\n" +
				" （神之子不装备封印的武器。)\r\n" +
			...
			cm.sendOk("你应该已经知道了，黑暗痕迹只有在特殊条件下才能被刻印上去。请在满足以下条件的同时击败#r高级麦格纳斯。\r\n\r\n" +
				"#e#r<任务完成条件>#k#n\r\n" +
				" #b- 独自攻破\r\n" +
				" - 只装备封印的创世武器和辅助武器\r\n" +
				" - 最终伤害降低50%\r\n" +
