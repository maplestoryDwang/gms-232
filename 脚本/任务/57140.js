                                ...
                                if (status === a++) {
                                    ...
                                    if (status === a++) {
                                        ...
                                        if (status === a++) {
                                            ...
                                            if (status === a++) {
                                                cm.sendNormalTalk_Bottom("我曾经利用这条路线进入过本能寺一次。所以说，我才是最适合承担起这个任务的人。", 57, 0, true, true)
                                            } else {
                                                if (status === a++) {
                                                    cm.sendNormalTalk_Bottom("#face0#信玄，你有没有看到剑斗的眼神？看他的眼神就知道，如果你不同意他参加任务，他肯定会独自一人闯进本能寺去。", 37, 9130009, true, true)
                                                } else {
                                                    if (status === a++) {
                                                        cm.sendNormalTalk_Bottom("#face0#啊哈哈！好吧，那就这么定了！这次的潜入任务就交给剑斗来执行吧！既然都这么说了，那这个任务只能交给你来办了！", 37, 9130000, true, true)
                                                    } else {
                                                        if (status === a++) {
                                                            cm.sendNormalTalk_Bottom("#face0#不过，独自一人执行任务实在是太危险了，就让幸村也与你同行吧。幸村！记得帮忙看好剑斗，让他不要乱来！", 37, 9130000, true, true)
                                                        } else {
                                                            if (status === a++) {
                                                                cm.sendNormalTalk_Bottom("#face0#就请放心交给我吧。", 37, 9130023, true, true)
                                                            } else {
                                                                if (status === a++) {
                                                                    cm.sendNormalTalk_Bottom("#face0#好了剑斗，那我就先一步前往本能寺东侧城墙了。请你在做好准备之后，就尽快赶来和我汇合吧。", 37, 9130023, true, true)
                                                                } else {
                                                                    if (status === a++) {
                                                                        cm.sendNormalTalk_Bottom("#face0#本能寺就位于枫叶原2的北侧。好了，我先走一步了。", 37, 9130023, true, true)
                                                                    } else {
                                                                        if (status === a++) {
                                                                            cm.forceStartQuest(57140, "");
                                                                            cm.OnStartNavigation(807050200, 1, "9130080", 0);
                                                                            cm.dispose()
                                                                        }
                                                                    }
                                                                }
...
function stage0(d, c, b) {
    ...
    if (status <= a++) {
        ...
        if (status == a++) {
            var e = cm.getQuest();
            cm.askYesNo("这个任务的依次对话脚本还没有修复哦。它的脚本位于： #b 脚本/任务/57140.js#k\r\n\r\n如果你有兴趣，欢迎一起来修复！\r\n\r\n那么现在，你要立刻开始这个任务吗？")
        } else {
            if (status == a++) {
                cm.forceStartQuest();
                cm.dispose()
...
function end(d, c, b) {
    ...
    if (status <= a++) {
        ...
        if (status == a++) {
            cm.sendNormalTalk_Bottom("#face0#剑斗，你来了啊。我一直在等着你呢。", 37, 9130023, false, true)
        } else {
            if (status === a++) {
                cm.forceCompleteQuest(57140);
                cm.gainExp(15927);
                cm.dispose()
            }
        }
