                        ...
                        if (status === v++) {
                          ...
                          if (status === v++) {
                            ...
                            if (status === v++) {
                              ...
                              cm.forceStartQuest(39804, '');
                              cm.updateInfoQuest(39800, "01=h0;02=h0;11=h1;04=h1");
                              cm.OnStartNavigation(410000500, 1, '3004404', 39804);
                              cm.dispose();
                            }
                          }
                        }
                                              ...
                                              if (status === v++) {
                                                ...
                                                if (status === v++) {
                                                  ...
                                                  if (status === v++) {
                                                    ...
                                                    cm.userSetFieldFloating(410000500, 3, 3, 5);
                                                    cm.inGameDirectionEvent_AskAnswerTime(1000);
                                                  } else {
                                                    if (status === v++) {
