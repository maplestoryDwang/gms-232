...
function start(d, c, b) {
    ...
    if (status <= a++) {
        ...
        if (status == a++) {
            ...
            if (status === a++) {
                cm.askYesNo("\r\n还有，你现在已经有足够资格成为荣耀特攻队的#b#e大师#n#k了。你准备好了吗？\r\n\r\n\r\n#e※ 完成该任务后，消耗#b1500个荣耀币#k，可在#r每个世界领取1次#k以下道具。\r\n\r\n#b#i2630692:# <#t2630692:#>#k#n", 0, 3004201)
            } else {
                if (status === a++) {
                    if (cm.getNumberFromQuestInfo(100296, "point") < 1500) {
                        cm.sendNormalTalk("\r\n#b#e荣耀币#n#k是你执行任务的证明，有了它才能晋升阶位。\r\n\r\n#r※ 升至大师阶需要消耗1500个荣耀币。", 0, 3004201, false, false);
                        cm.dispose();
                        return
                    }
                    cm.forceCompleteQuest(500806);
                    cm.gainGloryEventPoint(-1500 * 100);
                    cm.setNumberForQuestInfo(500785, "lv", 4);
                    cm.teachSkill(80000613, -1, 0);
                    cm.teachSkill(80000614, 0, -1);
                    cm.teachSkill(80000614, 1, 1);
                    ...
                    if (status === a++) {
                        ...
                        if (status === a++) {
                            ...
                            if (status === a++) {
                                cm.sendNormalTalk_Bottom("那么，从现在起我任命你为荣耀特攻队的#r<大师>#k阶队员。#b#h0##k。", 37, 3004201, false, true)
                            } else {
                                if (status === a++) {
