            ...
            if (status == 2) {
                if (cm.getPlayerStat("RSP") > (cm.getPlayerStat("LVL") - 70) * 3) {
                    ...
                    if (cm.canHold(1142068)) {
                        ...
                        cm.changeJob(1311);
                        cm.sendOk("#h0#, as of this moment, you are now the Knight Sergeant. From this moment on, you shall carry yourself with dignity and respect befitting your new title The Knight Sergeant of Knights of cygnus. May your glory shines as bright as it is right now.")
                    } else {
