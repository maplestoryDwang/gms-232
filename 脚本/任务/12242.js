...
function start(d, b, a) {
    ...
    if (status == 0) {
        cm.askMenu("我正在向你指引通过打猎，可提升#b#t4001527##k指数的地区。有什么能帮忙的吗？\r\n#b#L0#查看符合我等级的打猎场#l\r\n#L1#查看全部打猎场#l\r\n#L2#结束对话#l")
    } else {
        if (status == 1) {
            switch (a) {
                case 0:
                    var c = "按照各个等级所推荐的打猎场就是这里了。\r\n#b按下[W]键后查看世界地图。#k\r\n";
                    if (cm.getLevel() >= 15 && cm.getLevel() <= 29) {
                        c += selStr01
                    }
                    if (cm.getLevel() >= 30 && cm.getLevel() <= 34) {
                        c += selStr02
                    }
                    if (cm.getLevel() >= 35 && cm.getLevel() <= 42) {
                        c += selStr03
                    }
                    if (cm.getLevel() >= 40 && cm.getLevel() <= 45) {
                        c += selStr04
                    }
                    if (cm.getLevel() >= 43 && cm.getLevel() <= 50) {
                        c += selStr05
                    }
                    if (cm.getLevel() >= 45 && cm.getLevel() <= 50) {
                        c += selStr06
                    }
                    if (cm.getLevel() >= 50 && cm.getLevel() <= 62) {
                        c += selStr07
                    }
                    if (cm.getLevel() >= 50 && cm.getLevel() <= 55) {
                        c += selStr08
                    }
                    if (cm.getLevel() >= 50 && cm.getLevel() <= 64) {
                        c += selStr09
                    }
                    if (cm.getLevel() >= 67 && cm.getLevel() <= 75) {
                        c += selStr10
                    }
                    if (cm.getLevel() >= 65 && cm.getLevel() <= 82) {
                        c += selStr11
                    }
                    if (cm.getLevel() >= 71 && cm.getLevel() <= 84) {
                        c += selStr12
                    }
                    if (cm.getLevel() >= 77 && cm.getLevel() <= 83) {
                        c += selStr13
                    }
                    if (cm.getLevel() >= 79 && cm.getLevel() <= 95) {
                        c += selStr14
                    }
                    if (cm.getLevel() >= 94 && cm.getLevel() <= 112) {
                        c += selStr15
                    }
                    if (cm.getLevel() >= 113 && cm.getLevel() <= 121) {
                        c += selStr16
                    }
                    if (cm.getLevel() >= 115 && cm.getLevel() <= 121) {
                        c += selStr17
                    }
                    if (cm.getLevel() >= 122 && cm.getLevel() <= 142) {
                        c += selStr18
                    }
                    if (cm.getLevel() >= 140 && cm.getLevel() <= 150) {
                        c += selStr19
                    }
                    if (cm.getLevel() >= 150 && cm.getLevel() <= 160) {
                        c += selStr20
                    }
                    if (cm.getLevel() >= 160 && cm.getLevel() <= 200) {
                        c += selStr21
                    }
                    status = -1;
                    cm.sendNext(c);
