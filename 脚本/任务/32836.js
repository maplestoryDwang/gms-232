...
function start(d, c, b) {
    ...
    if (status <= a++) {
        ...
        if (status == a++) {
            cm.sendNormalTalk_Bottom("希拉？麦格纳斯？那是谁？奥尔卡不认识他们。", 37, 1530130, false, true)
        } else {
            if (status === a++) {
                cm.sendNormalTalk_Bottom("不过你，怎么不先和奥尔卡通话呢？啊，谁，谁在等你的电话了？我才没有！奥尔卡不高兴了，走了！", 37, 1530130, true, true)
            } else {
                if (status === a++) {
                    cm.sendNormalTalk_Bottom("脾气还真是不好惹……从奥尔卡这里没获得任何有用情报。和3楼教室的#b伊莉娜#k对话吧。", 57, 1530134, true, true)
                } else {
                    if (status === a++) {
                        cm.forceCompleteQuest(32836);
                        cm.dispose();
                        cm.warp(330000300, 0)
                    }
                }
