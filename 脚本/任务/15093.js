      ...
      if (status === G++) {
        ...
        if (status === G++) {
          ...
          if (status === G++) {
            ...
            if (status === G++) {
              cm.forceStartQuest();
              cm.sendNormalTalk("请你利用自己强大的力量，消灭#b10次#k#b混沌血腥女王#k。", 0, 1064002, false, true, 0);
            } else {
              if (status === G++) {
                cm.sendNormalTalk("给你#i1142904:# #b#t1142904##k作为礼物吧。", 0, 1064002, true, true, 0);
              } else {
                if (status === G++) {
...
function end(V, W, c) {
  ...
  if (status <= G++) {
    ...
    cm.sendNormalTalk("你真是太了不起了！请收下这份礼物！#b#i1142904##z1142904#", 0, 1064002, true, false, 0);
    cm.forceCompleteQuest();
    cm.gainItem(1142904, 1);
    cm.forceCompleteQuest(15098);
    cm.dispose();
  }
}