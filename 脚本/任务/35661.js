...
function start(mode, type, selection) {
	...
	if (status <= i++) {
		...
		cm.askYesNo("请前去攻破黑魔法师的残像，找到1个#i4036461# #b#z4036461#，#k然后攻破军团长#r高级斯乌#k的残像，可以吗？", 4, 9063152);
	} else if (status == i++) {
		cm.forceStartQuest();
		var jobId = cm.getJob();
		cm.sendOk("你应该已经知道了，黑暗痕迹只有在特殊条件下才能被刻印上去。请在满足以下条件的同时击败#r高级斯乌。#k\r\n\r\n" +
			"#e#r<任务完成条件>#k#n\r\n" +
			" #b- 独自攻破\r\n" +
			" - 最终伤害降低20%\r\n\r\n" +
