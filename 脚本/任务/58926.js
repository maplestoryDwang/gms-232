                                ...
                                if (status === a++) {
                                    ...
                                    if (status === a++) {
                                        ...
                                        if (status === a++) {
                                            ...
                                            if (status === a++) {
                                                cm.forceCompleteQuest(58926);
                                                cm.forceStartQuest(58949, "4th");
                                                cm.eventSKill(0);
                                                cm.setInGameDirectionMode(false, true, false);
                                                cm.setStandAloneMode(false);
                                                cm.updateInfoQuest(58972, "m035=clear;dr1=clear;dr2=clear;m037=clear;m038=clear;m039=clear");
...
function stage0(d, c, b) {
    ...
    if (status <= a++) {
        ...
        if (status == a++) {
            var e = cm.getQuest();
            cm.askYesNo("这个任务的依次对话脚本还没有修复哦。它的脚本位于： #b 脚本/任务/58926.js#k\r\n\r\n如果你有兴趣，欢迎一起来修复！\r\n\r\n那么现在，你要立刻开始这个任务吗？")
        } else {
            if (status == a++) {
                cm.forceStartQuest();
                cm.dispose()
