...
function action(d, c, b) {
    ...
    if (status <= a++) {
        ...
        if (status === a++) {
            cm.updateInfoQuest(63509, "d=1;e=1");
            ...
            if (status === a++) {
                cm.updateInfoQuest(64949, "O_ATB1=1;O_ATB2=1;O_ATB3=0");
                cm.fieldEffect_KinesisEXP(Math.pow(cm.getLevel(), 3) * 2);
                cm.updateInfoQuest(64949, "O_ATB1=1;O_ATB2=1;O_ATB3=1");
                ...
                if (status === a++) {
                    ...
                    cm.warp(867142500, 0, false);
                    cm.eventSKill(0);
                    cm.setInGameDirectionMode(false, true, false);
                    cm.updateInfoQuest(64950, "check2=b2_03;check3=b3_03;check4=b4_00;check=b1_03");
                    cm.dispose()
                }
            }
        }
