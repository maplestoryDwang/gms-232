function enter() {
    ...
    if (cm.getNumberFromQuestInfo(33181, "army") < 5) {
        cm.openScriptNpc()
    }
}
var status = -1;
    ...
    if (status <= a++) {
        ...
        if (status === a++) {
            ...
            if (status === a++) {
                ...
                if (status === a++) {
                    cm.inGameDirectionEvent_PushScaleInfo(0, 2000, 0, -60, 59)
                } else {
                    if (status === a++) {
                        cm.npc_SetSpecialAction("oid=22407688", "none", -1, 1);
                        cm.inGameDirectionEvent_ChangeEquipment([1390002]);
                                ...
                                if (status === a++) {
                                    ...
                                    if (status === a++) {
                                        ...
                                        if (status === a++) {
                                            ...
                                            if (status === a++) {
                                                cm.addPopupSay(1540629, 1000, "呃啊呃……#h0#……?", "", 0);
                                                            ...
                                                            if (status === a++) {
                                                                ...
                                                                if (status === a++) {
                                                                    ...
                                                                    if (status === a++) {
                                                                        ...
                                                                        cm.updateInfoQuest(33181, "army=5;faker1=1;faker2=0;faker3=0");
