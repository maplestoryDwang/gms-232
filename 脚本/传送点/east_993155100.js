function enter() {
    if (cm.getMap().getNumMonsters() == cm.getMap().countMonsterById(8645120)) {
        if ((cm.getMapId() % 1000) == 300) {
            cm.updateInfoQuest(37511, "clear=1");
            cm.updateInfoQuest(37500, "00=h0;10=h1;11=h0;04=h0;23=h0;05=h0;06=h0;07=h1;25=h1;55=h0");
...
function action(d, c, b) {
    ...
    if (status <= a++) {
        ...
        if (status === a++) {
            cm.sendOk("这个传送点的脚本尚未修复。\r\n脚本位于： 脚本/传送点/east_993155100.js ", 0)
        } else {
            cm.dispose()
        }
    }
