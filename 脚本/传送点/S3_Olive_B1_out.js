...
function action(d, c, b) {
    ...
    if (status <= a++) {
        ...
        if (status === a++) {
            cm.updateInfoQuest(63511, "c=1;e=18");
            ...
            if (status === a++) {
                cm.updateInfoQuest(64949, "O_ATB1=0");
                cm.fieldEffect_KinesisEXP(Math.pow(cm.getLevel(), 3) * 2);
                cm.updateInfoQuest(64949, "O_ATB1=1");
                ...
                if (status === a++) {
                    ...
                    cm.eventSKill(0);
                    cm.warp(867142300, 0, false);
                    cm.setInGameDirectionMode(false, true, false);
                    cm.updateInfoQuest(64950, "check2=b2_00;check=b1_03");
                    cm.dispose()
                }
            }
        }
