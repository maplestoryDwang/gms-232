    ...
    if (status <= a++) {
        ...
        if (status === a++) {
            ...
            if (status === a++) {
                ...
                if (status === a++) {
                    cm.inGameDirectionEvent_PushScaleInfo(0, 2000, 0, 280, 59)
                } else {
                    if (status === a++) {
                        cm.npc_SetSpecialAction("oid=22407690", "none", -1, 1);
                                                            ...
                                                            if (status === a++) {
                                                                ...
                                                                if (status === a++) {
                                                                    ...
                                                                    if (status === a++) {
                                                                        ...
                                                                        cm.updateInfoQuest(33181, "army=7;faker1=1;faker2=0;faker3=0");
                                                                        cm.addPopupSay(1540617, 3000, "咳咳!谢谢你. \r\n不过……我的脖子怎么这么疼啊?好像被人抓住了脖子一样……", "", 0);
