...
function action(f, W, U) {
  ...
  if (cm.getNumberFromQuestInfo(34021, "hero1") == 3 || cm.getNumberFromQuestInfo(34021, "hero2") == 3) {
    cm.sendNormalTalk_Bottom("#face1#我们什么时候出发？", 37, 1540880, false, true);
    cm.dispose();
    return;
  }
  if (f == 1) {
