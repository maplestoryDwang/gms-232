...
var prize1 = Array(1442047, 2000000, 2000001, 2000002, 2000003, 2000004, 2000005, 2430036, 2430037, 2430038, 2430039, 2430040);
...
var prize4 = Array(1442048, 2430082, 2430072);
var prize5 = Array(1442048, 2430091, 2430092, 2430093, 2430101, 2430102);
var prize6 = Array(1442048, 1442050, 2430073, 2430074, 2430075, 2430076, 2430077);
var prize7 = Array(1442050, 3010183, 3010182, 3010053, 2430080);
var prize8 = Array(1442050, 3010178, 3010177, 3010075, 1442049, 2430053, 2430054, 2430055, 2430056, 2430103, 2430136);
var prize9 = Array(1442049, 3010123, 3010175, 3010170, 3010172, 3010173, 2430201, 2430228, 2430229);
var prize10 = Array(1442049, 3010172, 3010171, 3010169, 3010168, 3010161, 2430117, 2430118, 2430119, 2430120, 2430137);
var status = 0;
function start() {
  status = -1;
  action(1, 0, 0);
        ...
        if (status == 2) {
          if (U == 0) {
            ...
            if (U == 1) {
              ...
              if (U == 2) {
                var V = cm.getQuestRecord(160200);
                if (V.getCustomData() == null) {
                  V.setCustomData('0');
                }
                var w = parseInt(V.getCustomData());
                if (w + 3600000 >= cm.getCurrentTime() && !cm.getPlayer().isGM()) {
                  ...
                  if (!cm.canHold()) {
                    ...
                    V.setCustomData('' + cm.getCurrentTime());
                ...
                if (U == 3) {
                  var N = "你想兑换哪个连胜证明书?";
                  for (var u = 0; u < quantities.length; u++) {
                    N += "\r\n#b#L" + u + "##t" + (4031332 + u) + "# 兑换(需要" + quantities[u] + "个)#l";
                  }
                  cm.askMenu(N);
                  status = 9;
                }
          ...
          if (status == 3) {
            ...
            if (status == 10) {
              ...
              var B = java.lang.Math.floor(java.lang.Math.random() * c.length);
              if (!cm.haveItem(Q, m)) {
                cm.sendOk('你需要#b' + m + "#k个 #b#t" + Q + "##k 来兑换奖励");
