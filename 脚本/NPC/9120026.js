...
function action(f, W, U) {
  if (U != 6) {
    ...
    switch (U) {
      case 0:
        V = cm.getQuestStatus(4682) == 2;
        w = 802000200;
        N = 2;
        break;
      case 1:
        V = cm.getQuestStatus(4687) == 2;
        w = 802000300;
        N = 0;
        break;
      case 2:
        V = cm.getQuestStatus(4690) == 2;
        w = 802000500;
        N = 0;
        break;
      case 3:
        V = cm.getQuestStatus(4694) == 2;
        w = 802000600;
        N = 0;
        break;
      case 4:
        V = cm.getQuestStatus(50001) == 2;
        w = 802000700;
        N = 0;
        break;
      case 5:
        V = cm.getQuestStatus(50015) == 2;
        w = 802000800;
        N = 0;
        break;
      case 7:
        V = cm.getQuestStatus(50017) == 2;
        w = 802000820;
        N = 0;
        break;
    }
