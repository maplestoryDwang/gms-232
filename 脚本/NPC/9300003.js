...
function action(f, W, U) {
  ...
  if (status == 0) {
    ...
    if (status == 1) {
      var V = cm.getQuestRecord(160001);
      var w = V.getCustomData();
      if (w == null) {
        V.setCustomData('0');
        w = '0';
      }
      if (w === '0') {
                  ...
                  if (cm.MarrageChecking() == 4) {
                    ...
                    if (cm.MarrageChecking() == 5) {
                      ...
                      if (cm.MarrageChecking() == 6) {
                        ...
                        var N = cm.getMap().getCharacterById(cm.getPartyFormID());
                        if (N == null) {
                        ...
                        V.setCustomData('2_');
                        cm.cm.forceStartQuest(160001, '2_');
                        cm.doWeddingEffect(N);
                      }
                    }
                  }
                }
        ...
        if (w === '2_' || w === '2') {
          ...
          var N = cm.getMap().getCharacterById(cm.getPlayer().getMarriageId());
          if (N == null) {
            cm.sendOk("请确定你的伴侣是在同一地图.");
            cm.dispose();
            return;
          }
          cm.cm.forceStartQuest(160001, '3');
          cm.cm.forceStartQuest(160001, '3');
          var u = parseInt(cm.getQuestRecord(160002).getCustomData());
          if (u > 10) {
            cm.warpMap(700000200, 0);
          } else {
            cm.cm.forceStartQuest(160002, '0');
            cm.cm.forceStartQuest(160002, '0');
