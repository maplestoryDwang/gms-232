  ...
  if (status <= V++) {
    ...
    if (status === V++) {
      if (!cm.isQuestActive(37712)) {
        ...
        if (N || u || Q || m || c) {
          cm.addNumberForQuestInfo(37712, "flower", 1);
          cm.addPopupSay(0, 2000, "#face0#已经调查了#r" + cm.getNumberFromQuestInfo(37712, 'flower') + "朵#k花。再去调查一下其他花吧。", '', 0);
        } else {
