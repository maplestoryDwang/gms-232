...
function action(f, W, U) {
  ...
  switch (status) {
    ...
    case 3:
      ...
      } else if (cm.haveItem(4020012, 1) && cm.haveItem(4032181, 1000)) {
    ...
    case 10:
      ...
      } else if (cm.haveItem(4032168, 1) && cm.haveItem(4032181, 2500) && cm.haveItem(4032170, 1) && cm.haveItem(2330003, 1) && cm.getMeso() >= 150000000) {
        cm.gainItem(4032170, -1);
        cm.gainItem(4032168, -1);
