...
function action(f, W, U) {
  ...
  if (cm.getNumberFromQuestInfo(34021, "hero1") == 0 || cm.getNumberFromQuestInfo(34021, "hero2") == 0) {
    cm.sendNormalTalk_Bottom("#face6#我们什么时候出发？", 37, 1540878, false, true);
    cm.dispose();
    return;
  }
  if (f == 1) {
