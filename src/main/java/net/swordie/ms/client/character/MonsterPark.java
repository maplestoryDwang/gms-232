...
public class MonsterPark {
    ...
    static {
        ...
        mobExpHash.put(9800187, 690955); // Happy Erda
        mobExpHash.put(9800188, 709725); // Raging Erda
        mobExpHash.put(9800189, 728705); // Sad Erda
        mobExpHash.put(9800191, 769200); // Stone Erda
        mobExpHash.put(9800192, 788635); // Blazing Erda
        mobExpHash.put(9800193, 808290); // Soulful Erda
        mobExpHash.put(9800194, 830185); // Tranquil Erda
        mobExpHash.put(9800195, 850170); // Lantern Erda
        mobExpHash.put(9800196, 870255); // Arma's Follower
        mobExpHash.put(9800197, 7252190); // Arma
        mobExpHash.put(9800198, 2480030); // Pinedeer
        mobExpHash.put(9800199, 2536730); // Bighorn Pinedeer
        mobExpHash.put(9800200, 2480030); // Ewenana
        mobExpHash.put(9800201, 2536730); // Ramanana
        mobExpHash.put(9800202, 2600470); // Flyon
        mobExpHash.put(9800203, 2658080); // Angry Flyon
        mobExpHash.put(9800204, 2600470); // Unripe Wolfruit
        mobExpHash.put(9800205, 2658080); // Ripe Wolfruit
        mobExpHash.put(9800206, 2716210); // Green Catfish
        mobExpHash.put(9800207, 2840430); // Blue Catfish
        mobExpHash.put(9800208, 2781380); // Rhyturtle
        mobExpHash.put(9800209, 2840430); // Boss Rhyturtle
        mobExpHash.put(9800210, 2906790); // Crilia
        mobExpHash.put(9800211, 3033940); // Patriarch Crilia
        mobExpHash.put(9800212, 2966530); // Birdshark
        mobExpHash.put(9800213, 3033940); // Patriarch Birdshark
        mobExpHash.put(9800214, 3033940); // Slurpy Tree
        mobExpHash.put(9800215, 4951520); // Paper Bag Alley Citizen
        mobExpHash.put(9800216, 5061055); // Wood Board Alley Citizen
        mobExpHash.put(9800217, 5061055); // Gallina
        mobExpHash.put(9800218, 5159570); // Gallus
        mobExpHash.put(9800219, 5159570); // Angry Victory Plate
        mobExpHash.put(9800220, 5270670); // Crooked Victory Plate
        mobExpHash.put(9800221, 5483520); // Red Dancing Shoes
        mobExpHash.put(9800222, 5270670); // Angry Masquerade Citizen
        mobExpHash.put(9800223, 5370800); // Insane Masquerade Citizen
        mobExpHash.put(9800224, 5597375); // Dreamkeeper
        mobExpHash.put(9800225, 5699455); // Blue-eyed Gargoyle
        mobExpHash.put(9800226, 5814880); // Red-eyed Gargoyle
        mobExpHash.put(9800227, 10000070); // Dreamkeeper(Boss)
        mobExpHash.put(9800228, 82260580); // Water Spirit
        mobExpHash.put(9800229, 8422155); // Sun Spirit
        mobExpHash.put(9800230, 8584340); // Earth Spirit
        mobExpHash.put(9800231, 8729740); // Snow Spirit
        mobExpHash.put(9800232, 8894380); // Thunder Spirit
        mobExpHash.put(9800233, 9060640); // Toxic Spirit
        mobExpHash.put(9800234, 9227440); // Volatile Spirit
        mobExpHash.put(9800235, 9376595); // Befuddled Spirit
        mobExpHash.put(9800236, 9545840); // Anguished Spirit
        mobExpHash.put(9800237, 9716070); // Mournful Spirit
        mobExpHash.put(9800238, 9887305); // Discordant Spirit
        mobExpHash.put(9800239, 29999980); // Corrupt Spirit of Harmony
    }
