...
public enum SkillStat {
    ...
    atGauge1Con, // charm power cost
    atGauge2Con, // scroll power cost
    atGauge2Inc, // scroll power inc
    atSkillType, // Ho Young element
    ;
    ...
    public BaseStat getBaseStat() {
        switch (this) {
            ...
            case criticaldamage:
            case cdPerM: // Legion's crDmg  |   Needs to be  / 100
            ...
            case expR:
            case indieExp:
            case expRPerM: // Legion's expR |   Needs to be / 100
            ...
            case reduceForceR: // DF
                return BaseStat.costForceR;
            case nbdR:
                return BaseStat.nbd;
            case disCountR:
            ...
            case coolTimeR:
                return BaseStat.reduceCooltimeR;
            case onHitHpRecoveryR: // 70% chance to recover <onHitHpRecoveryR> % of MaxHP
                return BaseStat.onHitHpRecoveryR;
            case onHitMpRecoveryR: // 70% chance to recover <onHitMpRecoveryR> % of MaxMP
                return BaseStat.onHitMpRecoveryR;
            case expLossReduceR:
                return BaseStat.deathPenaltyDurationDecR;
        }
        return null;
    }
}
