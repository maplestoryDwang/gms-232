...
public class MobAttackInfo {
    ...
    public int psychicLockInfo1;
    public int psychicLockInfo2;
    ...
    public byte unk214;
    public boolean mobDies;
    public long totalDamage; // total damage on mob
    ...
    public MobAttackInfo deepCopy() {
        ...
        mai.psychicLockInfo1 = psychicLockInfo1;
        mai.psychicLockInfo2 = psychicLockInfo2;
        mai.rocketRushInfo = rocketRushInfo;
        mai.mobDies = mobDies;
        mai.totalDamage = totalDamage;
        return mai;
    }
}
