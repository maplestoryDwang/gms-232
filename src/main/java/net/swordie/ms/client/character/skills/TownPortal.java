...
import net.swordie.ms.connection.packet.TownPortalPool;
...
public class TownPortal {
    ...
    public void spawnTownPortal() {
        ...
        EventManager.stopTimer(despawnTimer);
        despawnTimer = EventManager.addEvent(this::despawnTownPortal, getDuration(), TimeUnit.SECONDS);

        fieldField.broadcastPacket(TownPortalPool.townPortalCreated(this, false)); // Broadcasts spawning of the TownPortal to the fieldField.
    ...
    public void despawnTownPortal() {
        ...
        fieldField.broadcastPacket(TownPortalPool.townPortalRemoved(this, false));
    ...
    public void showTownPortal(Field field) {
        if(field.getInfo().isTown()) {
            ...
            chr.write(TownPortalPool.townPortalCreated(this, true));
        }
    }
}
