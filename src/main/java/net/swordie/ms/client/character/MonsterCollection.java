...
import net.swordie.orm.dao.MonsterCollectionDao;
import net.swordie.orm.dao.MonsterCollectionExplorationDao;
import net.swordie.orm.dao.MonsterCollectionRewardDao;
...
public class MonsterCollection {
    ...
    private static final MonsterCollectionExplorationDao monsterCollectionExplorationDao = (MonsterCollectionExplorationDao) SworDaoFactory.getByClass(MonsterCollectionExploration.class);

    private int id;
    private Map<Integer, MonsterCollectionRegion> collection = new HashMap<>();

    private Set<Integer> mobs;

    private Set<MonsterCollectionReward> monsterCollectionRewards;

    private Set<MonsterCollectionExploration> monsterCollectionExplorations;
    ...
    public Set<Integer> getMobs() {
        if (mobs == null) {
            mobs = monsterCollectionDao.getMobsByMonsterCollection(this);
        }
        return mobs;
    }
    ...
    public Set<MonsterCollectionReward> getMonsterCollectionRewards() {
        if (monsterCollectionRewards == null) {
            monsterCollectionRewards = new HashSet<>();
        }
    ...
    public Set<MonsterCollectionExploration> getMonsterCollectionExplorations() {
        if (monsterCollectionExplorations == null) {
            monsterCollectionExplorations = monsterCollectionRewardDao.byMonsterCollection(this);
        }
    ...
    public MonsterCollectionExploration createExploration(int region, int session, int group) {
        ...
        MonsterCollectionExploration mce = new MonsterCollectionExploration(this, collectionKey, ft);
    ...
    public void removeExploration(MonsterCollectionExploration mce) {
        ...
        monsterCollectionExplorationDao.delete(mce);
    }
