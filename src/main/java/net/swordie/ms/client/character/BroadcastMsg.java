...
public class BroadcastMsg {
    ...
    public void encode(OutPacket outPacket) {
        ...
        switch (getBroadcastMsgType()) {
            ...
            case ItemMegaphone:
                ...
                var subType = getArg3(); // 1 = item, 2 = achievement
                ChatModule.encodeLinkedMessage(outPacket, getItem(), subType == 1 ?
                        ChatModule.LinkedMessageType.Item
                        : ChatModule.LinkedMessageType.Nothing);
                break;
            ...
            case BlueChat_ItemInfo_2:
                subType = getArg3(); // 1 = item, 2 = achievement
                ChatModule.encodeLinkedMessage(outPacket, getItem(), subType == 1 ?
                        ChatModule.LinkedMessageType.Item
                        : ChatModule.LinkedMessageType.Nothing);
                break;
    ...
    public static BroadcastMsg itemMegaphone(String string, byte channel, boolean whisperEar, boolean containsItem,
        ...
        broadcastMsg.setArg3((byte) (containsItem ? 1 : 0)); // subType, 0 = nothing, 1 = item, 2 = achievement
