...
public class Archer extends Beginner {
    ...
    public void handleSkill(Char chr, TemporaryStatManager tsm, int skillId, int slv, InPacket inPacket, SkillUseInfo skillUseInfo) {
        ...
        switch (skillId) {
            ...
            case Marksman.ILLUSION_STEP_XBOW:
                o1.nOption = si.getValue(indieDEX, slv);
                o1.rOption = skillId;
                o1.tOption = si.getValue(time, slv);
    ...
    public void handleLevelUp() {
        ...
        boolean isPathfinder = JobConstants.isPathFinder(chr.getJob());
        if (level == 30) {
            if (isPathfinder) {
                chr.setJob(JobConstants.JobEnum.PATHFINDER_2.getJobId());
            ...
            if (isPathfinder) {
                chr.setJob(JobConstants.JobEnum.PATHFINDER_3.getJobId());
                chr.setStatAndSendPacket(Stat.job, chr.getJob());
            ...
            if (isPathfinder) {
                chr.setJob(JobConstants.JobEnum.PATHFINDER_4.getJobId());
                chr.setStatAndSendPacket(Stat.job, chr.getJob());
