...
public class MonsterCollectionSession {
    ...
    public void sendCompletionInfo(Char chr, int sessionKey) {
        ...
        chr.write(WvsContext.message(MessagePacket.collectionRecordMessage(sessionKey, stringBuilder.toString())));
    }
}
