...
public class Pet extends Life {
    ...
    public void broadcastSpawnPacket(Char onlyChar, EnterType enterType) {
        if (onlyChar == null && getField() != null) {
            getField().broadcastPacket(UserLocal.petActivateChange(this, true, (byte) 0));
        } else if (onlyChar != null) {
            onlyChar.write(UserLocal.petActivateChange(this, true, (byte) 0));
        }
        // onlyChar and field are null, nothing to broadcast to
    }
