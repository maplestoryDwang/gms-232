...
public enum MobSkillID {
    ...
    RetroWorldLaser(251),
    GloomLaserBeam(252),
    BlueExplosion(253), // Ruler of the sky
    SplinteredSerpentSummon(254),
    Unk2(255),
    SomeDarkness(256),
    RetroWorldSkill(257),
    //
    ...
    public CharacterTemporaryStat getAffectedCTS() {
        switch (this) {
            ...
            case DeathMark:
                return CharacterTemporaryStat.DeathMark;
            case DispelItemOption:
                return CharacterTemporaryStat.DispelItemOption;
            case Attract:
                return CharacterTemporaryStat.Attract;
            case VenomSnake:
                return CharacterTemporaryStat.VenomSnake;
            case Lapidification:
                return CharacterTemporaryStat.Lapidification;
            case Undead:
                return CharacterTemporaryStat.Undead;
            case DarkTornado:
                return CharacterTemporaryStat.DarkTornado;
            case GiveMeHeal:
                return CharacterTemporaryStat.GiveMeHeal;
            case ReverseInput:
                return CharacterTemporaryStat.ReverseInput;
            case CapDebuffRed:
            case CapDebuffBlue:
                return CharacterTemporaryStat.CapDebuff;
            case StopMotion:
                return CharacterTemporaryStat.StopMotion;
            case StopPortion:
                return CharacterTemporaryStat.StopPortion;
        }
        return null;
    }
}
