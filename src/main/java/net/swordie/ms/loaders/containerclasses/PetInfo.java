...
public class PetInfo {
    ...
    private boolean noMoveToLocker;
    ...
    public void setNoMoveToLocker(boolean noMoveToLocker) {
        this.noMoveToLocker = noMoveToLocker;
    }

    public boolean isNoMoveToLocker() {
        return noMoveToLocker;
    }
}
