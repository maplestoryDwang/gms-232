...
public class ClockPacket {
    ...
    private ClockPacket(ClockType clockType, int arg1) {
        this.clockType = clockType;
        this.startTime = Util.getCurrentTimeLong();
        this.arg1 = arg1;
    }
    ...
    public long getCurDuration(){return Util.getCurrentTimeLong() - startTime;}

    public static ClockPacket eventTimer(int time) {
        return new ClockPacket(ClockType.EventTimer, time);
    }

    public static ClockPacket DojoTimer(int maxTime, int curTime){
        return new ClockPacket(ClockType.TimerInfoEx, maxTime, curTime);
    }
