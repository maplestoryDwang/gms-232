...
public enum ForceAtomEnum {
    ...
    RUNE_OF_PURIFICATION_1(29, 6), // Rune of Purification
    RUNE_OF_PURIFICATION_2(29, 7), // Rune of Purification
    RUNE_OF_PURIFICATION_3(29, 8), // Rune of Purification
    ...
    SILHOUTTE_MIRAGE(56, 3), // Bow Master 4th V
    ...
    CLONE_SEAL(60, 1), // HoYoung

    BUTTERFLY_DREAM_1(61, 1), // Blue
    BUTTERFLY_DREAM_2(61, 2), // Green
    BUTTERFLY_DREAM_3(61, 3), // Red
    BUTTERFLY_DREAM_4(61, 4), // Yellow
    BUTTERFLY_DREAM_5(61, 5), // Purple

    UNK_62(62, 1),

    MOB_SUCTION(63, 1), // HoYoung

    MECH_ROCKET_1(64, 1),
    MECH_ROCKET_2(64, 2),
    // More from 209

    DEFENSIVE_FORMATION(66, 1), // Beast Tamer - Hawk

    MIGHTY_MJOLNIR(67, 1), // Paladin 4th V skill
    ;
    ...
    public boolean isRemoveByPacketAtom() {
        return this == MIGHTY_MJOLNIR;
    }
