...
public enum RoomLeaveType {
    // General types to be made more specific within MiniRoom Implementations
    RoomClosed(-1337),
    RoomFull(-1337),
    KickedOut(-1337),
    LeftRoom(-1337),
    ...
    MRLeave_UserRequest(0), // You left the Room
    MRLeave_WrongPosition(1),
    MRLeave_Closed(2),
    MRLeave_HostOut(3), // Room is closed
    MRLeave_Booked(4), // You left the Room
    MRLeave_Kicked(5), // You have been expelled
