 ...
 * Can be found in Effect.wz/BasicEff.img/ObtacleAtom
 */
...
public enum ObstacleAtomEnum {
    ...
    PapulatusPurpleKey(60, 25),
    PapulatusYellowKey(61, 40),

    Ursus(62, 25),

    WillTriggerTestDangerous(63, 25),
    WillTriggerTestSafe(64, 20),

    GloomBlind(65, 30),
    GloomStun(66, 30),
    GloomUndead(67, 30),

    BlackMageStraight(75, 30),
    BlackMageStraightBig(75, 50),
    BlackMageAngled(77, 20),
    ...
    ObstacleAtomEnum(int type, int hitBox) {
        this.type = type;
        this.hitBox = hitBox;
    }
